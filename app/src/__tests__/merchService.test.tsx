...
describe("useMerchService — CRUD operations", () => {
  ...
  describe("useUpdateMerch", () => {
    it("updates a merch item with partial payload", async () => {
      ...
      const { result } = renderHook(() => useMerchService().useUpdateMerch(1), {
        wrapper: Wrapper,
      });
    ...
    it("rejects when update API fails", async () => {
      ...
      const { result } = renderHook(() => useMerchService().useUpdateMerch(99), {
        wrapper: Wrapper,
      });
  ...
  describe("useDeleteMerch", () => {
    it("deletes a merch item successfully", async () => {
      ...
      const { result } = renderHook(() => useMerchService().useDeleteMerch(1), {
        wrapper: Wrapper,
      });
    ...
    it("rejects when delete API fails", async () => {
      ...
      const { result } = renderHook(() => useMerchService().useDeleteMerch(999), {
        wrapper: Wrapper,
      });
