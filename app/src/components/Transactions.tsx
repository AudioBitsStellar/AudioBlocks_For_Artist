        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-gray-700">
              ...
              <th className="text-left text-gray-400 text-sm font-semibold pb-3">Song</th>
              <th className="text-left text-gray-400 text-sm font-semibold pb-3">Value</th>
              <th className="text-left text-gray-400 text-sm font-semibold pb-3">Date</th>
              <th className="text-left text-gray-400 text-sm font-semibold pb-3">View</th>
            </tr>
          </thead>
          <tbody>
