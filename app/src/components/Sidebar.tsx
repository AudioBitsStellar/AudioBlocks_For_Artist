          ...
          {navItems.map((item) => {
            ...
            return (
              <Link
                ...
                href={item.href}
                onClick={onClose}
                className={`flex items-center gap-3 px-4 py-3 rounded-lg transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-purple-500 focus-visible:ring-offset-2 focus-visible:ring-offset-[#161616]
                  ${
                    isActive
                      ? 'text-pink-500'
        ...
        <div className="p-4">
          ...
          {legalLinks.map((link) => (
            <Link
              ...
              href={link.href}
              onClick={onClose}
              className="block text-gray-400 text-sm hover:text-white py-1 rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-purple-500 focus-visible:ring-offset-2 focus-visible:ring-offset-[#161616]"
            >
              {link.name}
            </Link>
          ))}
